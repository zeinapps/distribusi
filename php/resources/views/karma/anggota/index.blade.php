                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{ $item->email }}</td>
                                <td>{{ $item->alamat }}</td>
                                <td>{{ $item->membernama }}</td>
                                <td>{{ $item->jumlah_transaksi }}</td>
                                <td>{{ $item->is_verify?'Aktif':'NonAktif' }}</td>
                                <td class="">
                                    
                                    <!--<a href="/anggota/edit/{{ $item->id }}" class="btn-less"><i class="fa fa-pencil"></i></a>--> 
                                    <!--<a href="#" class="btn-less"><i class="fa fa-trash-o"></i></a>-->  
                                    <!--<a href="#" class="btn-less"><i class="fa fa-file"></i></a>--> 
                                    <a href="/anggota/{{ $item->id }}" class="btn btn-info btn-mini">detil</a> 
                                    @if($item->tawari)
                                        <a href="/tawari/{{ $item->id }}" class="btn btn-info btn-mini">Tawari</a> 
                                    @endif
