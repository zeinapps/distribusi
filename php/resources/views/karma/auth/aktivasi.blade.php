...
<div id="login-box">
    <div class="login-box-inner clearfix">
        ...
        <div class="powerwizard-content">
            <form id="form-signup" action="/aktivasi" method="post">
                <div class="powerwizard-step">
                    <h2>Aktivasi</h2>
                    <p>Isikan Kode Sponsor / Kode Afiliasi</p>
                    <div class="spacer-40"></div>
                    <div class="row">
                        <div class="col-lg-4">
                            <label for="fcid-1">Kode: <span class="asterisk">*</span></label>
                        </div>
                        <div class="col-lg-8">
                            <input class="form-control required" type="hidden" value="{{ $data['aktivasi_token'] }}" name="aktivasi_token" id="fcid-1"/>
                            <input class="form-control required" type="text" placeholder="Kode Sponsor" name="kode" id="fcid-1"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <button class="btn btn-default pull-right">Aktivasi</button>
                        </div>
                    </div>
