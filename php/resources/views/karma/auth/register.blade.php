...
<div id="login-box">
    <div class="login-box-inner clearfix">
        ...
        <div class="powerwizard-content">
            <form id="form-signup" action="registrasi" method="post">
                <div class="powerwizard-step">
                    <h2>Registrasi</h2>
                    <p>Isikan Nama dan Email Anda</p>
                    <div class="spacer-40"></div>
                    <div class="row">
                        <div class="col-lg-4">
                            <label for="fcid-1">Nama: <span class="asterisk">*</span></label>
                        </div>
                        <div class="col-lg-8">
                            <input class="form-control required" type="text" placeholder="Nama" name="nama" id="fcid-1"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <label for="fcid-4">Email: <span class="asterisk">*</span></label>
                        </div> 
                        <div class="col-lg-8">
                            <input class="form-control required" type="text" name="email" placeholder="Email" id="fcid-4"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <button class="btn btn-default pull-right">Register account!</button>
                        </div>
                    </div>
