                ...
                <table class="table" id="tablesorting-1">
                    <thead>
                        <tr>
                            <th >Kode</th>
                            <th >Nama</th>
                            <th class="filter-select" >Kategori</th>
                            <th >Satuan</th>
                            <th >Harga</th>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td class="">
                                    ...
                                    <a href="/barang/edit/{{ $item->id }}" class="btn-less"><i class="fa fa-pencil"></i></a> 
                                    <!--<a href="#" class="btn-less"><i class="fa fa-trash-o"></i></a>-->  
                                    <!--<a href="#" class="btn-less"><i class="fa fa-file"></i></a>--> 
                                    <a href="/barang/{{ $item->id }}" class="btn-less"><i class="fa fa-info-circle"></i></a> 
