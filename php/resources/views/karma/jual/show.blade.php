    ...
    <div class="tab-content">
        <div class="inner-padding">
            ...
            @if($confirm)
                ...
                <div class="row"> 
                    <div class="col-sm-3"> 
                        <label>Konfirmasi Rekening</label>
                    </div>
                    <div class="col-sm-6">
                        {{ $confirm->nomer_rekening }}
                    </div>
                </div>
                <div class="row"> 
                    <div class="col-sm-3"> 
                    ...
                    <div class="col-sm-6">
                        {{ $confirm->nama_pemilik }}
                    </div>
                </div>
                <div class="row"> 
                    <div class="col-sm-3"> 
                        <label>Konfirmasi jumlah</label>
                    </div>
                    <div class="col-sm-6">
                        {{ $confirm->jumlah }}
                    </div>
                ...
                <div class="row"> 
                    <div class="col-sm-3"> 
                        <label>Konfirmasi Tanggal</label>
                    </div>
                    <div class="col-sm-6">
                        {{ $confirm->waktu }}
                    </div>
            ...
            @else
                <div class="row"> 
                    <div class="col-sm-3"> 
                        <label>Konfirmasi Pembayaran Tidak ada</label>
                    </div>
            ...
            <div class="spacer-25"></div>
            @if($data->status_id == 1)
                <a href="/jual/verify/{{$data->id}}" class="btn btn-success">Approve</a>
            @endif
