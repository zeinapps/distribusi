                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td class="">
                                    ...
                                    <a href="/stok/edit/{{ $item->id }}" class="btn-less"><i class="fa fa-pencil"></i></a> 
                                    <!--<a href="#" class="btn-less"><i class="fa fa-trash-o"></i></a>-->  
                                    <!--<a href="#" class="btn-less"><i class="fa fa-file"></i></a>--> 
                                    <!--<a href="/stok/{{ $item->id }}" class="btn-less"><i class="fa fa-info-circle"></i></a>--> 
